...
export const seedDatabase = async () => {
  try {
    ...
    console.log('[Seed] Creating sample notifications for all 7 triggers...');
    await Notification.create([
      {
        recipient: student._id,
        title: 'Enrollment Confirmed: Full-Stack Web Development Bootcamp',
        message: 'You have been successfully enrolled. Begin your journey with Lesson 1!',
        type: 'course_enrollment',
        link: `/student/course/${course1._id}/learn`,
        isRead: false,
        read: false,
      ...
      {
        recipient: student._id,
        title: 'New Course Published: Cloud Computing & Microservices',
        message: 'Prof. Alex Rivera published a brand new course on AWS, Docker, and Kubernetes.',
        type: 'new_course',
        link: `/course/${course2._id}`,
        isRead: false,
        read: false,
      ...
      {
        recipient: student._id,
        title: 'New Lesson Available: Advanced State Management with Redux Toolkit',
        message: 'A new lesson has been added to Full-Stack Web Development Bootcamp. Check it out now!',
        type: 'new_lesson',
        link: `/student/course/${course1._id}/learn`,
        isRead: false,
        read: false,
      ...
      {
        recipient: student._id,
        title: 'Quiz Result: Full-Stack Architecture Assessment',
        message: 'Congratulations! You passed with a score of 95% (Passed).',
        type: 'quiz_result',
        link: `/student/course/${course1._id}/learn`,
        isRead: false,
        read: false,
      ...
      {
        recipient: student._id,
        title: 'Course Completed: Modern UI/UX Design Systems',
        message: 'Outstanding achievement! You completed 100% of all curriculum lessons.',
      ...
      {
        recipient: student._id,
        title: 'Certificate Generated: Modern UI/UX Design Systems',
        message: `Your accredited Certificate #${certCode} has been minted with distinction.`,
      ...
      {
        recipient: student._id,
        title: 'Announcement: Live Architecture Q&A Session Tomorrow',
        message: 'Prof. Alex Rivera: "We will be hosting an interactive live AMA on microservices design tomorrow at 5 PM UTC."',
        type: 'instructor_announcement',
        link: `/course/${course1._id}`,
        isRead: false,
        read: false,
